...
\end{singlespace}
\end{center}
Something about how data representations in population genetics allow us to better understand different facets of evolution, and machine learning is the most suitable approach for various flexible representations specific to a given task.
\clearpage
